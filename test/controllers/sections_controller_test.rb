...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { school_id: @section.school_id, sec: @section.sec, std: @section.std } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { school_id: @section.school_id, sec: @section.sec, std: @section.std } }
